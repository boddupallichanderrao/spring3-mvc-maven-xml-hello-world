pipeline{
    ...
    stages{
        stage('get scm'){
            steps{
                git credentialsId: 'CHANDER204', url: 'https://github.com/boddupallichanderrao/spring3-mvc-maven-xml-hello-world.git'
            }
        }
        stage('maven build'){
            steps{
     ...
     post {
        ...
        always {
            step([$class: 'Mailer',
                ...
                recipients: "boddupalli.chanderrao@gmail.com",
